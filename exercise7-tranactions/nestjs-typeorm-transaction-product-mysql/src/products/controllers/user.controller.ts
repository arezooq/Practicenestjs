...
import { CreateUserEventLike } from '../dtos/CreateUserEventLike.dto';
...
export class UserController {
  ...
  @Post('/like')
  createUserLike(@Body() createUserEventLike: CreateUserEventLike) {
    return this.userService.createUserEventLike(createUserEventLike);
  }

  @Post('/like')
  createUserLikeQuery(@Body() createUserEventLike: CreateUserEventLike) {
    return this.userService.createUserLike(createUserEventLike);
  }
}
